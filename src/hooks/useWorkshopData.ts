  ...
  return [
    {
      ...
      products: [
        { id: 'glue-001', model: t('products.workshop.glueGun.001.model'), description: t('products.workshop.glueGun.001.description'), image: '/img/CP/gfang/jqiang/Q0A-DW02-4V/1300-Q0A-DW02-4V-01.jpg' },
    ...
    },
    {
      ...
      products: [
        { id: 'pol-001', model: t('products.workshop.polisher.001.model'), description: t('products.workshop.polisher.001.description'), image: '/img/CP/gfang/pguang/S0P-DW05-150/1300-S0P-DW05-150-01.jpg' },
        { id: 'pol-002', model: t('products.workshop.polisher.002.model'), description: t('products.workshop.polisher.002.description'), image: '/img/CP/gfang/pguang/S1P-DW01-180/1300-S1P-DW01-180-01.jpg' },
      ],
    },
  ];
}
